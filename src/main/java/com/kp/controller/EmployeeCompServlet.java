...
public class EmployeeCompServlet extends HttpServlet {
     ...
     private void loadEmployeeComTable(HttpServletRequest req, HttpServletResponse resp) throws IOException {
          String email = req.getSession().getAttribute("email").toString();
          
          ComplaintDao dao = new ComplaintDao();
          List<Complaint> list = dao.getComplaintOfEmpByEmail(email);
          ...
          resp.sendRedirect("dashboard.jsp?page=employee"); // 🔥 Use redirect, not forward
     }
